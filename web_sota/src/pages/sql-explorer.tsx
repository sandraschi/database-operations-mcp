      ...
      <div className="col-span-3 space-y-4">
        <Card className="border-slate-800 bg-slate-950/50">
          ...
          <CardContent className="p-0">
            <SchemaItem
              label="calibre_library (metadata.db)"
              items={[
                "books",
                "authors",
                "tags",
          ...
          <CardHeader className="flex flex-row items-center justify-between py-2 border-b border-slate-800">
            <Tabs defaultValue="query1">
              <TabsList className="bg-transparent gap-2">
                ...
                <TabsTrigger value="query2" className="text-xs">
                  Analytics Users
                </TabsTrigger>
              </TabsList>
            </Tabs>
            ...
            <table className="w-full text-xs text-left">
              ...
              <tbody className="text-slate-300">
                <tr className="hover:bg-slate-800/30">
                  <td className="px-4 py-2 border-b border-slate-900 font-mono">
                    1
                  </td>
    ...
    <div className="group">
      ...
      <div className="hidden group-hover:block ml-8 border-l border-slate-800">
        {items.map((item) => (
          <div
            key={item}
            className="flex items-center gap-2 px-4 py-1.5 hover:text-white text-slate-500 text-xs transition-colors cursor-pointer capitalize"
          >
