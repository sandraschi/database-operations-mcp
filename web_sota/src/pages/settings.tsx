    ...
    <Card className="border-slate-800 bg-slate-950/50">
      <CardHeader>
        ...
        <CardDescription className="text-slate-400">
          Configure which LLM backend the AI tools use (agentic workflow, NL
          control, log analysis).
          {status === "ready" ? (
      ...
      <CardContent className="space-y-4">
        ...
        <p className="text-xs text-slate-500">
          Saved to browser storage. Used by the LLM Chat page and AI tools
          (agentic workflows, natural language control, log analysis).
        </p>
      </CardContent>
    </Card>
  );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400">
          Tool surface preferences, LLM provider, and MCP feature status
        </p>
      </div>
      ...
      <div className="grid gap-6">
        <Card className="border-slate-800 bg-slate-950/50">
          <CardHeader>
            ...
            <CardDescription className="text-slate-400">
              Local UI preference for how you want to operate the server
              surface.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-xs text-slate-500">
              This preference is UI-side only; backend env vars control
        ...
        <Card className="border-slate-800 bg-slate-950/50">
          <CardHeader>
            ...
            <CardDescription className="text-slate-400">
              Live capability report from backend.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
