    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400">
          FastMCP 3.1 feature visibility for prompts, resources, skills, and
          workflows.
        </p>
      </div>
      ...
      <Card className="border-slate-800 bg-slate-950/50">
        <CardHeader>
          ...
          <CardDescription className="text-slate-400">
            Reported by backend capability introspection.
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-wrap gap-2">
          <Badge className="bg-slate-800 text-slate-100 border-0">
            FastMCP: {data?.fastmcp ?? "unknown"}
          </Badge>
          <Badge className="bg-slate-800 text-slate-100 border-0">
          ...
          <Badge className="bg-slate-800 text-slate-100 border-0">
            Workflows:{" "}
            {data?.agentic_workflows?.available ? "available" : "not detected"}
          </Badge>
          <Badge className="bg-slate-800 text-slate-100 border-0">
