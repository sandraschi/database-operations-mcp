...
class ToolTester:
    ...
    def compile_recommendations(self):
        ...
        if indentation_modules:
            recommendations.append(
                f"Fix indentation in modules: {', '.join(indentation_modules)}"
            )
        
        if import_modules:
            recommendations.append(
                f"Fix relative imports in modules: {', '.join(import_modules)}"
            )
