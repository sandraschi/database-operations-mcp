...
class ToolTester:
    ...
    def test_function_with_mock_params(self, module_name: str, func_name: str, func: callable) -> Dict[str, Any]:
        ...
        try:
            ...
            dangerous_names = ['delete', 'drop', 'create', 'insert', 'update', 'remove', 'connect', 'disconnect']
    ...
    def generate_report(self):
        ...
        for module_name, module_results in self.results["tools"].items():
            ...
            if module_results.get('import_error'):
                ...
                report.append(f"  Tests: {module_results['tests_passed']} passed, {module_results['tests_failed']} failed")
