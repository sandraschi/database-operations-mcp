...
def analyze_mcp_decorators(file_path: Path) -> dict[str, Any]:
    ...
    try:
        ...
        return {"decorators": decorators, "issues": issues, "total_decorators": len(decorators)}

    except Exception as e:
        return {"error": str(e), "decorators": [], "issues": [], "total_decorators": 0}
...
class TestMCPCompliance:
    ...
    def test_mcp_decorators_present(self):
        ...
        excluded_files = {"firefox\\exceptions.py", "firefox\\help_system.py"}
