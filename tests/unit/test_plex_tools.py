...
class TestExportPlexLibrary(unittest.TestCase):
    ...
    def _create_test_database(self, db):
        ...
        with db.conn:
            ...
            ''')
            cursor.execute("INSERT INTO library_sections (id, name, section_type) VALUES (1, 'Test Section', 1)")
            cursor.execute("INSERT INTO media_items (id, library_section_id, media_item_title) VALUES (1, 1, 'Test Item')")
