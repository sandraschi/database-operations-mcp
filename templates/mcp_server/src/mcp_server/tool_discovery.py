...
from typing import Dict, Type, Any, Optional, List, TypeVar, Callable
...
try:
    ...
    from typing import TypedDict, Any, Optional, Dict, Type, List, TypeVar, Callable
        ...
        for _, module_name, is_pkg in pkgutil.iter_modules([str(package_dir)]):
            ...
            try:
                ...
                for name, obj in inspect.getmembers(module, inspect.isclass):
                    if (issubclass(obj, FastMCPTool) and 
                            obj != FastMCPTool and 
