...
def register_tools(mcp):
    ...
    mcp.tool()(list_windows_databases)
    mcp.tool()(manage_plex_metadata)
    mcp.tool()(query_windows_database)
    mcp.tool()(clean_windows_database)
    
    logger.info("Registered Windows tools")
