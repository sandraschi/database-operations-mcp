...
def register_tools(mcp):
    ...
    return {
        'find_plex_database': find_plex_database,
        'optimize_plex_database': optimize_plex_database,
        'export_database_schema': export_database_schema,
        'get_plex_library_stats': get_plex_library_stats
    }
