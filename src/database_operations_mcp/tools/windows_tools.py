...
WINDOWS_DB_PATHS = {
    ...
    'firefox_history': [
        os.path.expanduser(r'~\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\*.default-release\\places.sqlite'),
        os.path.expanduser(r'~\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\*.default\\places.sqlite')
    ],
    'edge_history': [
    ...
    'brave_history': [
        ...
        os.path.expandvars(r'%USERPROFILE%\\AppData\\Local\\BraveSoftware\\Brave-Browser\\User Data\\Default\\History')
    ],
    'outlook': [
...
PLEX_PATHS = {
    'metadata': [
        ...
        os.path.expandvars(r'%LOCALAPPDATA%\\Plex Media Server\\Plug-in Support\\Databases\\com.plexapp.plugins.library.db')
    ],
    'cache': [
