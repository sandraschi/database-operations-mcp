...
class MongoDBConnector(BaseDatabaseConnector):
    ...
    def execute_query(self, query: Dict, database_name: str = None, collection_name: str = None, **kwargs) -> Dict[str, Any]:
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            metrics = {
                ...
                'wiredTiger': server_status.get('wiredTiger', {}).get('cache', {}) if 'wiredTiger' in server_status else {},
